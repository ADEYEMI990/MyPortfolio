  ...
  return (
    <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-16 lg:py-0">
      ...
      <div className="lg:flex lg:justify-between lg:gap-4">
        ...
        <header className="lg:sticky lg:top-0 lg:flex lg:w-[48%] lg:flex-col lg:justify-between lg:py-24">
          ...
          <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
            ...
            <li className="mr-5 shrink-0 text-xs">
              <a
                className="block hover:text-slate-200"
                href="https://www.linkedin.com/in/ibrahim-adeyemi-474930324/"
                target="_blank"
                rel="noreferrer noopener"
        ...
        <main
          id="content"
          className="pt-24 lg:w-[52%] lg:h-screen lg:overflow-y-auto lg:py-24 text-white"
        >
          {/* About Section */}
          <section
            id="about"
          ...
          >
            ...
            <div>
              <ol className="group/list">
                <li className="mb-12">
                  <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                    ...
                    >
                      2024 — Present (Freelance/Volunteer)
                    </header>
              ...
              <div className="mt-12">
                <a
                  className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 font-semibold text-slate-200 group/link text-base"
                  href="https://eu.docworkspace.com/d/sINPDw8OSAvT9k8sG?sa=601.1037"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="View Full Résumé (opens in a new tab)"
                >
